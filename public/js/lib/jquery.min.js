(() => {
  ...
  (function(e, t) {
    var n, r, i = typeof t, o = e.document, a = e.location, s = e.jQuery, u = e.$, l = {}, c = [], p = "1.9.1", f = c.concat, d = c.push, h = c.slice, g = c.indexOf, m = l.toString, y = l.hasOwnProperty, v = p.trim, b = function(e2, t2) {
      ...
      (o.addEventListener || "load" === e2.type || "complete" === o.readyState) && (q(), b.ready());
    }, q = function() {
    ...
    b.fn = b.prototype = {
        ...
        if ("string" == typeof e2) {
          ...
          if (i2[1]) {
            if (n2 = n2 instanceof b ? n2[0] : n2, b.merge(this, b.parseHTML(i2[1], n2 && n2.nodeType ? n2.ownerDocument || n2 : o, true)), C.test(i2[1]) && b.isPlainObject(n2))
              for (i2 in n2) b.isFunction(this[i2]) ? this[i2](n2[i2]) : this.attr(i2, n2[i2]);
            return this;
          }
          if (a2 = o.getElementById(i2[2]), a2 && a2.parentNode) {
            if (a2.id !== i2[2]) return r2.find(e2);
      ...
      for ("boolean" == typeof s2 && (c2 = s2, s2 = arguments[1] || {}, u2 = 2), "object" == typeof s2 || b.isFunction(s2) || (s2 = {}), l2 === u2 && (s2 = this, --u2); l2 > u2; u2++)
        if (null != (o2 = arguments[u2]))
          for (i2 in o2) e2 = s2[i2], r2 = o2[i2], s2 !== r2 && (c2 && r2 && (b.isPlainObject(r2) || (n2 = b.isArray(r2))) ? (n2 ? (n2 = false, a2 = e2 && b.isArray(e2) ? e2 : []) : a2 = e2 && b.isPlainObject(e2) ? e2 : {}, s2[i2] = b.extend(c2, a2, r2)) : r2 !== t && (s2[i2] = r2));
      return s2;
    }, b.extend({
      noConflict: function(t2) {
        return e.$ === b && (e.$ = u), t2 && e.jQuery === b && (e.jQuery = s), b;
      },
      isReady: false,
      readyWait: 1,
      holdReady: function(e2) {
      ...
      isFunction: function(e2) {
        return "function" === b.type(e2);
      },
      isArray: Array.isArray || function(e2) {
        return "array" === b.type(e2);
      },
      ...
      type: function(e2) {
        return null == e2 ? e2 + "" : "object" == typeof e2 || "function" == typeof e2 ? l[m.call(e2)] || "object" : typeof e2;
      },
      isPlainObject: function(e2) {
        if (!e2 || "object" !== b.type(e2) || e2.nodeType || b.isWindow(e2)) return false;
        try {
          if (e2.constructor && !y.call(e2, "constructor") && !y.call(e2.constructor.prototype, "isPrototypeOf")) return false;
        } catch (n2) {
          return false;
        }
        var r2;
      ...
      parseHTML: function(e2, t2, n2) {
        ...
        "boolean" == typeof t2 && (n2 = t2, t2 = false), t2 = t2 || o;
      ...
      parseJSON: function(n2) {
        return e.JSON && e.JSON.parse ? e.JSON.parse(n2) : null === n2 ? n2 : "string" == typeof n2 && (n2 = b.trim(n2), n2 && k.test(n2.replace(S, "@").replace(A, "]").replace(E, ""))) ? Function("return " + n2)() : (b.error("Invalid JSON: " + n2), t);
      },
      ...
      each: function(e2, t2, n2) {
        ...
        if (n2) {
          if (a2) {
            for (; o2 > i2; i2++)
              if (r2 = t2.apply(e2[i2], n2), r2 === false) break;
          } else
            for (i2 in e2)
              if (r2 = t2.apply(e2[i2], n2), r2 === false) break;
        } else if (a2) {
          for (; o2 > i2; i2++)
            if (r2 = t2.call(e2[i2], i2, e2[i2]), r2 === false) break;
        } else
          for (i2 in e2)
            if (r2 = t2.call(e2[i2], i2, e2[i2]), r2 === false) break;
        return e2;
      ...
      trim: v && !v.call("\uFEFF\xA0") ? function(e2) {
        return null == e2 ? "" : v.call(e2);
      } : function(e2) {
        return null == e2 ? "" : (e2 + "").replace(T, "");
      },
      makeArray: function(e2, t2) {
        var n2 = t2 || [];
        return null != e2 && (M(Object(e2)) ? b.merge(n2, "string" == typeof e2 ? [e2] : e2) : d.call(n2, e2)), n2;
      },
      inArray: function(e2, t2, n2) {
        var r2;
        if (t2) {
          if (g) return g.call(t2, e2, n2);
          for (r2 = t2.length, n2 = n2 ? 0 > n2 ? Math.max(0, r2 + n2) : n2 : 0; r2 > n2; n2++)
            if (n2 in t2 && t2[n2] === e2) return n2;
        }
        return -1;
      },
      merge: function(e2, n2) {
        ...
        if ("number" == typeof r2)
          for (; r2 > o2; o2++) e2[i2++] = n2[o2];
        else
          while (n2[o2] !== t) e2[i2++] = n2[o2++];
      ...
      map: function(e2, t2, n2) {
        ...
        if (a2)
          for (; o2 > i2; i2++) r2 = t2(e2[i2], i2, n2), null != r2 && (s2[s2.length] = r2);
        else
          for (i2 in e2) r2 = t2(e2[i2], i2, n2), null != r2 && (s2[s2.length] = r2);
        return f.apply([], s2);
      },
      guid: 1,
      proxy: function(e2, n2) {
        var r2, i2, o2;
        return "string" == typeof n2 && (o2 = e2[n2], n2 = e2, e2 = o2), b.isFunction(e2) ? (r2 = h.call(arguments, 2), i2 = function() {
      ...
      access: function(e2, n2, r2, i2, o2, a2, s2) {
        ...
        if ("object" === b.type(r2)) {
          o2 = true;
          for (u2 in r2) b.access(e2, n2, u2, r2[u2], true, a2, s2);
          ...
          for (; l2 > u2; u2++) n2(e2[u2], r2, s2 ? i2 : i2.call(e2[u2], u2, n2(e2[u2], r2)));
      ...
      if (!n)
        ...
        else if (o.addEventListener) o.addEventListener("DOMContentLoaded", H, false), e.addEventListener("load", H, false);
        else {
          o.attachEvent("onreadystatechange", H), e.attachEvent("onload", H);
          var r2 = false;
          try {
            r2 = null == e.frameElement && o.documentElement;
          } catch (i2) {
          }
    ...
    function M(e2) {
      ...
      return b.isWindow(e2) ? false : 1 === e2.nodeType && t2 ? true : "array" === n2 || "function" !== n2 && (0 === t2 || "number" == typeof t2 && t2 > 0 && t2 - 1 in e2);
    }
    r = b(o);
    var _ = {};
    function F(e2) {
    ...
    b.Callbacks = function(e2) {
      e2 = "string" == typeof e2 ? _[e2] || F(e2) : b.extend({}, e2);
      var n2, r2, i2, o2, a2, s2, u2 = [], l2 = !e2.once && [], c2 = function(t2) {
          ...
          if (u2) {
            ...
            (function i3(t3) {
              b.each(t3, function(t4, n3) {
                var r3 = b.type(n3);
                "function" === r3 ? e2.unique && p2.has(n3) || u2.push(n3) : n3 && n3.length && "string" !== r3 && i3(n3);
              });
        ...
        remove: function() {
          return u2 && b.each(arguments, function(e3, t2) {
            var r3;
            while ((r3 = b.inArray(t2, u2, r3)) > -1) u2.splice(r3, 1), n2 && (o2 >= r3 && o2--, a2 >= r3 && a2--);
          }), this;
        },
        has: function(e3) {
      ...
      Deferred: function(e2) {
        var t2 = [
          ...
          promise: function(e3) {
            return null != e3 ? b.extend(e3, r2) : r2;
          }
        }, i2 = {};
      ...
      when: function(e2) {
        var t2 = 0, n2 = h.call(arguments), r2 = n2.length, i2 = 1 !== r2 || e2 && b.isFunction(e2.promise) ? r2 : 0, o2 = 1 === i2 ? e2 : b.Deferred(), a2 = function(e3, t3, n3) {
          return function(r3) {
            t3[e3] = this, n3[e3] = arguments.length > 1 ? h.call(arguments) : r3, n3 === s2 ? o2.notifyWith(t3, n3) : --i2 || o2.resolveWith(t3, n3);
          };
        }, s2, u2, l2;
        if (r2 > 1)
          for (s2 = Array(r2), u2 = Array(r2), l2 = Array(r2); r2 > t2; t2++) n2[t2] && b.isFunction(n2[t2].promise) ? n2[t2].promise().done(a2(t2, l2, n2)).fail(o2.reject).progress(a2(t2, u2, s2)) : --i2;
        return i2 || o2.resolveWith(l2, n2), o2.promise();
      }
    }), b.support = function() {
      var t2, n2, r2, a2, s2, u2, l2, c2, p2, f2, d2 = o.createElement("div");
      if (d2.setAttribute("className", "t"), d2.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", n2 = d2.getElementsByTagName("*"), r2 = d2.getElementsByTagName("a")[0], !n2 || !r2 || !n2.length) return {};
      s2 = o.createElement("select"), l2 = s2.appendChild(o.createElement("option")), a2 = d2.getElementsByTagName("input")[0], r2.style.cssText = "top:1px;float:left;opacity:.5", t2 = {
        getSetAttribute: "t" !== d2.className,
        leadingWhitespace: 3 === d2.firstChild.nodeType,
        tbody: !d2.getElementsByTagName("tbody").length,
        htmlSerialize: !!d2.getElementsByTagName("link").length,
        style: /top/.test(r2.getAttribute("style")),
        hrefNormalized: "/a" === r2.getAttribute("href"),
        opacity: /^0.5/.test(r2.style.opacity),
        cssFloat: !!r2.style.cssFloat,
        checkOn: !!a2.value,
        optSelected: l2.selected,
        enctype: !!o.createElement("form").enctype,
        html5Clone: "<:nav></:nav>" !== o.createElement("nav").cloneNode(true).outerHTML,
        ...
        pixelPosition: false
      }, a2.checked = true, t2.noCloneChecked = a2.cloneNode(true).checked, s2.disabled = true, t2.optDisabled = !l2.disabled;
      try {
        delete d2.test;
      } catch (h2) {
        t2.deleteExpando = false;
      }
      a2 = o.createElement("input"), a2.setAttribute("value", ""), t2.input = "" === a2.getAttribute("value"), a2.value = "t", a2.setAttribute("type", "radio"), t2.radioValue = "t" === a2.value, a2.setAttribute("checked", "t"), a2.setAttribute("name", "t"), u2 = o.createDocumentFragment(), u2.appendChild(a2), t2.appendChecked = a2.checked, t2.checkClone = u2.cloneNode(true).cloneNode(true).lastChild.checked, d2.attachEvent && (d2.attachEvent("onclick", function() {
      ...
      return d2.style.backgroundClip = "content-box", d2.cloneNode(true).style.backgroundClip = "", t2.clearCloneStyle = "content-box" === d2.style.backgroundClip, b(function() {
        ...
        u3 && (n3 = o.createElement("div"), n3.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", u3.appendChild(n3).appendChild(d2), d2.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", a3 = d2.getElementsByTagName("td"), a3[0].style.cssText = "padding:0;margin:0;border:0;display:none", p2 = 0 === a3[0].offsetHeight, a3[0].style.display = "", a3[1].style.display = "none", t2.reliableHiddenOffsets = p2 && 0 === a3[0].offsetHeight, d2.innerHTML = "", d2.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t2.boxSizing = 4 === d2.offsetWidth, t2.doesNotIncludeMarginInBodyOffset = 1 !== u3.offsetTop, e.getComputedStyle && (t2.pixelPosition = "1%" !== (e.getComputedStyle(d2, null) || {}).top, t2.boxSizingReliable = "4px" === (e.getComputedStyle(d2, null) || {
          width: "4px"
        }).width, r3 = d2.appendChild(o.createElement("div")), r3.style.cssText = d2.style.cssText = s3, r3.style.marginRight = r3.style.width = "0", d2.style.width = "1px", t2.reliableMarginRight = !parseFloat((e.getComputedStyle(r3, null) || {}).marginRight)), typeof d2.style.zoom !== i && (d2.innerHTML = "", d2.style.cssText = s3 + "width:1px;padding:1px;display:inline;zoom:1", t2.inlineBlockNeedsLayout = 3 === d2.offsetWidth, d2.style.display = "block", d2.innerHTML = "<div></div>", d2.firstChild.style.width = "5px", t2.shrinkWrapBlocks = 3 !== d2.offsetWidth, t2.inlineBlockNeedsLayout && (u3.style.zoom = 1)), u3.removeChild(n3), n3 = d2 = a3 = r3 = null);
      }), n2 = s2 = u2 = l2 = r2 = a2 = null, t2;
    }();
    var O = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/, B = /([A-Z])/g;
    function P(e2, n2, r2, i2) {
      if (b.acceptData(e2)) {
        var o2, a2, s2 = b.expando, u2 = "string" == typeof n2, l2 = e2.nodeType, p2 = l2 ? b.cache : e2, f2 = l2 ? e2[s2] : e2[s2] && s2;
        if (f2 && p2[f2] && (i2 || p2[f2].data) || !u2 || r2 !== t) return f2 || (l2 ? e2[s2] = f2 = c.pop() || b.guid++ : f2 = s2), p2[f2] || (p2[f2] = {}, l2 || (p2[f2].toJSON = b.noop)), ("object" == typeof n2 || "function" == typeof n2) && (i2 ? p2[f2] = b.extend(p2[f2], n2) : p2[f2].data = b.extend(p2[f2].data, n2)), o2 = p2[f2], i2 || (o2.data || (o2.data = {}), o2 = o2.data), r2 !== t && (o2[b.camelCase(n2)] = r2), u2 ? (a2 = o2[n2], null == a2 && (a2 = o2[b.camelCase(n2)])) : a2 = o2, a2;
      }
    }
    function R(e2, t2, n2) {
      if (b.acceptData(e2)) {
        ...
        if (s2[u2]) {
          if (t2 && (o2 = n2 ? s2[u2] : s2[u2].data)) {
            ...
            for (r2 = 0, i2 = t2.length; i2 > r2; r2++) delete o2[t2[r2]];
            if (!(n2 ? $ : b.isEmptyObject)(o2)) return;
          }
    ...
    b.extend({
      ...
      data: function(e2, n2) {
        ...
        if (e2 === t) {
          if (this.length && (s2 = b.data(o2), 1 === o2.nodeType && !b._data(o2, "parsedAttrs"))) {
            for (r2 = o2.attributes; r2.length > a2; a2++) i2 = r2[a2].name, i2.indexOf("data-") || (i2 = b.camelCase(i2.slice(5)), W(o2, i2, s2[i2]));
    ...
    function W(e2, n2, r2) {
      if (r2 === t && 1 === e2.nodeType) {
        ...
        if (r2 = e2.getAttribute(i2), "string" == typeof r2) {
          try {
            r2 = "true" === r2 ? true : "false" === r2 ? false : "null" === r2 ? null : +r2 + "" === r2 ? +r2 : O.test(r2) ? b.parseJSON(r2) : r2;
          } catch (o2) {
          }
          b.data(e2, n2, r2);
        } else r2 = t;
    ...
    function $(e2) {
      var t2;
      for (t2 in e2)
        if (("data" !== t2 || !b.isEmptyObject(e2[t2])) && "toJSON" !== t2) return false;
      return true;
    }
    b.extend({
      queue: function(e2, n2, r2) {
        var i2;
      ...
      _queueHooks: function(e2, t2) {
        ...
        return b._data(e2, n2) || b._data(e2, n2, {
      ...
      queue: function(e2, n2) {
        var r2 = 2;
        return "string" != typeof e2 && (n2 = e2, e2 = "fx", r2--), r2 > arguments.length ? b.queue(this[0], e2) : n2 === t ? this : this.each(function() {
          var t2 = b.queue(this, e2, n2);
          b._queueHooks(this, e2), "fx" === e2 && "inprogress" !== t2[0] && b.dequeue(this, e2);
        });
      },
      dequeue: function(e2) {
        return this.each(function() {
      ...
      promise: function(e2, n2) {
        ...
        while (s2--) r2 = b._data(a2[s2], e2 + "queueHooks"), r2 && r2.empty && (i2++, r2.empty.add(u2));
    ...
    b.fn.extend({
      ...
      addClass: function(e2) {
        ...
        if (b.isFunction(e2)) return this.each(function(t3) {
          b(this).addClass(e2.call(this, t3, this.className));
        });
        if (u2) {
          for (t2 = (e2 || "").match(w) || []; s2 > a2; a2++)
            if (n2 = this[a2], r2 = 1 === n2.nodeType && (n2.className ? (" " + n2.className + " ").replace(X, " ") : " ")) {
              o2 = 0;
        ...
        if (u2) {
          for (t2 = (e2 || "").match(w) || []; s2 > a2; a2++)
            if (n2 = this[a2], r2 = 1 === n2.nodeType && (n2.className ? (" " + n2.className + " ").replace(X, " ") : "")) {
              o2 = 0;
              while (i2 = t2[o2++])
                while (r2.indexOf(" " + i2 + " ") >= 0) r2 = r2.replace(" " + i2 + " ", " ");
      ...
      toggleClass: function(e2, t2) {
        ...
        return b.isFunction(e2) ? this.each(function(n3) {
          ...
          if ("string" === n2) {
            ...
            while (o2 = l2[a2++]) u2 = r2 ? u2 : !s2.hasClass(o2), s2[u2 ? "addClass" : "removeClass"](o2);
          } else (n2 === i || "boolean" === n2) && (this.className && b._data(this, "__className__", this.className), this.className = this.className || e2 === false ? "" : b._data(this, "__className__") || "");
        });
      },
      hasClass: function(e2) {
        var t2 = " " + e2 + " ", n2 = 0, r2 = this.length;
        for (; r2 > n2; n2++)
          if (1 === this[n2].nodeType && (" " + this[n2].className + " ").replace(X, " ").indexOf(t2) >= 0) return true;
        return false;
      },
      val: function(e2) {
        var n2, r2, i2, o2 = this[0];
        {
          if (arguments.length) return i2 = b.isFunction(e2), this.each(function(n3) {
            var o3, a2 = b(this);
            1 === this.nodeType && (o3 = i2 ? e2.call(this, n3, a2.val()) : e2, null == o3 ? o3 = "" : "number" == typeof o3 ? o3 += "" : b.isArray(o3) && (o3 = b.map(o3, function(e3) {
              return null == e3 ? "" : e3 + "";
            })), r2 = b.valHooks[this.type] || b.valHooks[this.nodeName.toLowerCase()], r2 && "set" in r2 && r2.set(this, o3, "value") !== t || (this.value = o3));
          });
          if (o2) return r2 = b.valHooks[o2.type] || b.valHooks[o2.nodeName.toLowerCase()], r2 && "get" in r2 && (n2 = r2.get(o2, "value")) !== t ? n2 : (n2 = o2.value, "string" == typeof n2 ? n2.replace(U, "") : null == n2 ? "" : n2);
        }
      }
    }), b.extend({
      valHooks: {
        ...
        select: {
          get: function(e2) {
            var t2, n2, r2 = e2.options, i2 = e2.selectedIndex, o2 = "select-one" === e2.type || 0 > i2, a2 = o2 ? null : [], s2 = o2 ? i2 + 1 : r2.length, u2 = 0 > i2 ? s2 : o2 ? i2 : 0;
            for (; s2 > u2; u2++)
              if (n2 = r2[u2], !(!n2.selected && u2 !== i2 || (b.support.optDisabled ? n2.disabled : null !== n2.getAttribute("disabled")) || n2.parentNode.disabled && b.nodeName(n2.parentNode, "optgroup"))) {
                if (t2 = b(n2).val(), o2) return t2;
                a2.push(t2);
              }
            return a2;
          },
      ...
      attr: function(e2, n2, r2) {
        ...
        if (e2 && 3 !== u2 && 8 !== u2 && 2 !== u2) return typeof e2.getAttribute === i ? b.prop(e2, n2, r2) : (a2 = 1 !== u2 || !b.isXMLDoc(e2), a2 && (n2 = n2.toLowerCase(), o2 = b.attrHooks[n2] || (J.test(n2) ? z : I)), r2 === t ? o2 && a2 && "get" in o2 && null !== (s2 = o2.get(e2, n2)) ? s2 : (typeof e2.getAttribute !== i && (s2 = e2.getAttribute(n2)), null == s2 ? t : s2) : null !== r2 ? o2 && a2 && "set" in o2 && (s2 = o2.set(e2, r2, n2)) !== t ? s2 : (e2.setAttribute(n2, r2 + ""), r2) : (b.removeAttr(e2, n2), t));
      },
      removeAttr: function(e2, t2) {
        var n2, r2, i2 = 0, o2 = t2 && t2.match(w);
        if (o2 && 1 === e2.nodeType)
          while (n2 = o2[i2++]) r2 = b.propFix[n2] || n2, J.test(n2) ? !Q && G.test(n2) ? e2[b.camelCase("default-" + n2)] = e2[r2] = false : e2[r2] = false : b.attr(e2, n2, ""), e2.removeAttribute(Q ? n2 : r2);
      },
      attrHooks: {
        type: {
          set: function(e2, t2) {
            if (!b.support.radioValue && "radio" === t2 && b.nodeName(e2, "input")) {
              var n2 = e2.value;
      ...
      prop: function(e2, n2, r2) {
        var i2, o2, a2, s2 = e2.nodeType;
        if (e2 && 3 !== s2 && 8 !== s2 && 2 !== s2) return a2 = 1 !== s2 || !b.isXMLDoc(e2), a2 && (n2 = b.propFix[n2] || n2, o2 = b.propHooks[n2]), r2 !== t ? o2 && "set" in o2 && (i2 = o2.set(e2, r2, n2)) !== t ? i2 : e2[n2] = r2 : o2 && "get" in o2 && null !== (i2 = o2.get(e2, n2)) ? i2 : e2[n2];
      },
      propHooks: {
        tabIndex: {
          get: function(e2) {
      ...
      get: function(e2, n2) {
        var r2 = b.prop(e2, n2), i2 = "boolean" == typeof r2 && e2.getAttribute(n2), o2 = "boolean" == typeof r2 ? K && Q ? null != i2 : G.test(n2) ? e2[b.camelCase("default-" + n2)] : !!i2 : e2.getAttributeNode(n2);
      ...
      b.attrHooks[n2] = b.extend(b.attrHooks[n2], {
        set: function(e3, r2) {
    ...
    b.event = {
      ...
      add: function(e2, n2, r2, o2, a2) {
        ...
        if (v2) {
          ...
          while (l2--) s2 = rt.exec(n2[l2]) || [], g2 = y2 = s2[1], m2 = (s2[2] || "").split(".").sort(), p2 = b.event.special[g2] || {}, g2 = (a2 ? p2.delegateType : p2.bindType) || g2, p2 = b.event.special[g2] || {}, d2 = b.extend({
            type: g2,
            origType: y2,
            data: o2,
            handler: r2,
        ...
        if (m2 && (c2 = m2.events)) {
          ...
          while (l2--)
            if (s2 = rt.exec(t2[l2]) || [], d2 = g2 = s2[1], h2 = (s2[2] || "").split(".").sort(), d2) {
              ...
              for (d2 in c2) b.event.remove(e2, d2 + t2[l2], n2, r2, true);
      ...
      trigger: function(n2, r2, i2, a2) {
        ...
        if (l2 = f2 = i2 = i2 || o, 3 !== i2.nodeType && 8 !== i2.nodeType && !nt.test(g2 + b.event.triggered) && (g2.indexOf(".") >= 0 && (m2 = g2.split("."), g2 = m2.shift(), m2.sort()), u2 = 0 > g2.indexOf(":") && "on" + g2, n2 = n2[b.expando] ? n2 : new b.Event(g2, "object" == typeof n2 && n2), n2.isTrigger = true, n2.namespace = m2.join("."), n2.namespace_re = n2.namespace ? RegExp("(^|\\.)" + m2.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n2.result = t, n2.target || (n2.target = i2), r2 = null == r2 ? [n2] : b.makeArray(r2, [n2]), p2 = b.event.special[g2] || {}, a2 || !p2.trigger || p2.trigger.apply(i2, r2) !== false)) {
          if (!a2 && !p2.noBubble && !b.isWindow(i2)) {
            for (c2 = p2.delegateType || g2, nt.test(c2 + g2) || (l2 = l2.parentNode); l2; l2 = l2.parentNode) h2.push(l2), f2 = l2;
            f2 === (i2.ownerDocument || o) && h2.push(f2.defaultView || f2.parentWindow || e);
          }
          d2 = 0;
          while ((l2 = h2[d2++]) && !n2.isPropagationStopped()) n2.type = d2 > 1 ? c2 : p2.bindType || g2, s2 = (b._data(l2, "events") || {})[n2.type] && b._data(l2, "handle"), s2 && s2.apply(l2, r2), s2 = u2 && l2[u2], s2 && b.acceptData(l2) && s2.apply && s2.apply(l2, r2) === false && n2.preventDefault();
          if (n2.type = g2, !(a2 || n2.isDefaultPrevented() || p2._default && p2._default.apply(i2.ownerDocument, r2) !== false || "click" === g2 && b.nodeName(i2, "a") || !b.acceptData(i2) || !u2 || !i2[g2] || b.isWindow(i2))) {
      ...
      dispatch: function(e2) {
        ...
        if (u2[0] = e2, e2.delegateTarget = this, !c2.preDispatch || c2.preDispatch.call(this, e2) !== false) {
          ...
          while ((o2 = s2[n2++]) && !e2.isPropagationStopped()) {
            ...
            while ((i2 = o2.handlers[a2++]) && !e2.isImmediatePropagationStopped()) (!e2.namespace_re || e2.namespace_re.test(i2.namespace)) && (e2.handleObj = i2, e2.data = i2.data, r2 = ((b.event.special[i2.origType] || {}).handle || i2.handler).apply(o2.elem, u2), r2 !== t && (e2.result = r2) === false && (e2.preventDefault(), e2.stopPropagation()));
          }
      ...
      handlers: function(e2, n2) {
        ...
        if (u2 && l2.nodeType && (!e2.button || "click" !== e2.type)) {
          for (; l2 != this; l2 = l2.parentNode || this)
            if (1 === l2.nodeType && (l2.disabled !== true || "click" !== e2.type)) {
              for (o2 = [], a2 = 0; u2 > a2; a2++) i2 = n2[a2], r2 = i2.selector + " ", o2[r2] === t && (o2[r2] = i2.needsContext ? b(r2, this).index(l2) >= 0 : b.find(r2, this, null, [l2]).length), o2[r2] && o2.push(i2);
              o2.length && s2.push({
                elem: l2,
                handlers: o2
              });
        ...
        return n2.length > u2 && s2.push({
          elem: this,
          handlers: n2.slice(u2)
        }), s2;
      },
      fix: function(e2) {
        if (e2[b.expando]) return e2;
        ...
        while (t2--) n2 = r2[t2], e2[n2] = a2[n2];
        return e2.target || (e2.target = a2.srcElement || o), 3 === e2.target.nodeType && (e2.target = e2.target.parentNode), e2.metaKey = !!e2.metaKey, s2.filter ? s2.filter(e2, a2) : e2;
      },
      ...
      mouseHooks: {
        ...
        filter: function(e2, n2) {
          var r2, i2, a2, s2 = n2.button, u2 = n2.fromElement;
          return null == e2.pageX && null != n2.clientX && (i2 = e2.target.ownerDocument || o, a2 = i2.documentElement, r2 = i2.body, e2.pageX = n2.clientX + (a2 && a2.scrollLeft || r2 && r2.scrollLeft || 0) - (a2 && a2.clientLeft || r2 && r2.clientLeft || 0), e2.pageY = n2.clientY + (a2 && a2.scrollTop || r2 && r2.scrollTop || 0) - (a2 && a2.clientTop || r2 && r2.clientTop || 0)), !e2.relatedTarget && u2 && (e2.relatedTarget = u2 === e2.target ? n2.toElement : u2), e2.which || s2 === t || (e2.which = 1 & s2 ? 1 : 2 & s2 ? 3 : 4 & s2 ? 2 : 0), e2;
        }
      },
      special: {
        load: {
        ...
        click: {
          trigger: function() {
            return b.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(), false) : t;
          }
        },
        focus: {
          trigger: function() {
      ...
      simulate: function(e2, t2, n2, r2) {
        var i2 = b.extend(new b.Event(), n2, {
          type: e2,
          isSimulated: true,
          originalEvent: {}
        });
      ...
      setup: function() {
        return Z.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (b.event.add(this, "propertychange._change", function(e2) {
      ...
      b.event.special[t2] = {
        setup: function() {
          0 === n2++ && o.addEventListener(e2, r2, true);
        },
        teardown: function() {
          0 === --n2 && o.removeEventListener(e2, r2, true);
        }
      };
    }), b.fn.extend({
      on: function(e2, n2, r2, i2, o2) {
        var a2, s2;
        if ("object" == typeof e2) {
      ...
      off: function(e2, n2, r2) {
        var i2, o2;
        if (e2 && e2.preventDefault && e2.handleObj) return i2 = e2.handleObj, b(e2.delegateTarget).off(i2.namespace ? i2.origType + "." + i2.namespace : i2.origType, i2.selector, i2.handler), this;
        if ("object" == typeof e2) {
      ...
      var n2, r2, i2, o2, a2, s2, u2, l2, c2, p2, f2, d2, h2, g2, m2, y2, v2, x2 = "sizzle" + -/* @__PURE__ */ new Date(), w2 = e2.document, T2 = {}, N2 = 0, C2 = 0, k2 = it2(), E2 = it2(), S2 = it2(), A2 = typeof t2, j2 = 1 << 31, D2 = [], L2 = D2.pop, H2 = D2.push, q2 = D2.slice, M2 = D2.indexOf || function(e3) {
        var t3 = 0, n3 = this.length;
        for (; n3 > t3; t3++)
          if (this[t3] === e3) return t3;
        return -1;
      }, _2 = "[\\x20\\t\\r\\n\\f]", F2 = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", O2 = F2.replace("w", "w#"), B2 = "([*^$|!~]?=)", P2 = "\\[" + _2 + "*(" + F2 + ")" + _2 + "*(?:" + B2 + _2 + `*(?:(['"])((?:\\\\.|[^\\\\])*?)\\3|(` + O2 + ")|)|)" + _2 + "*\\]", R2 = ":(" + F2 + `)(?:\\(((['"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|` + P2.replace(3, 8) + ")*)|.*)\\)|)", W2 = RegExp("^" + _2 + "+|((?:^|[^\\\\])(?:\\\\.)*)" + _2 + "+$", "g"), $2 = RegExp("^" + _2 + "*," + _2 + "*"), I2 = RegExp("^" + _2 + "*([\\x20\\t\\r\\n\\f>+~])" + _2 + "*"), z2 = RegExp(R2), X2 = RegExp("^" + O2 + "$"), U2 = {
        ID: RegExp("^#(" + F2 + ")"),
        CLASS: RegExp("^\\.(" + F2 + ")"),
        NAME: RegExp(`^\\[name=['"]?(` + F2 + `)['"]?\\]`),
        TAG: RegExp("^(" + F2.replace("w", "w*") + ")"),
        ATTR: RegExp("^" + P2),
        PSEUDO: RegExp("^" + R2),
        CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + _2 + "*(even|odd|(([+-]|)(\\d*)n|)" + _2 + "*(?:([+-]|)" + _2 + "*(\\d+)|))" + _2 + "*\\)|)", "i"),
        needsContext: RegExp("^" + _2 + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + _2 + "*((?:-\\d)?\\d*)" + _2 + "*\\)|)(?=[^-]|$)", "i")
      ...
      function st2(e3, t3, n3, r3) {
        ...
        if ((t3 ? t3.ownerDocument || t3 : w2) !== p2 && c2(t3), t3 = t3 || p2, n3 = n3 || [], !e3 || "string" != typeof e3) return n3;
        if (1 !== (s3 = t3.nodeType) && 9 !== s3) return [];
        if (!d2 && !r3) {
          if (i3 = J2.exec(e3))
            if (a3 = i3[1]) {
              if (9 === s3) {
                if (o3 = t3.getElementById(a3), !o3 || !o3.parentNode) return n3;
                if (o3.id === a3) return n3.push(o3), n3;
              } else if (t3.ownerDocument && (o3 = t3.ownerDocument.getElementById(a3)) && y2(t3, o3) && o3.id === a3) return n3.push(o3), n3;
            } else {
              if (i3[2]) return H2.apply(n3, q2.call(t3.getElementsByTagName(e3), 0)), n3;
              if ((a3 = i3[3]) && T2.getByClassName && t3.getElementsByClassName) return H2.apply(n3, q2.call(t3.getElementsByClassName(a3), 0)), n3;
            }
          if (T2.qsa && !h2.test(e3)) {
            if (f3 = true, g3 = x2, m3 = t3, v3 = 9 === s3 && e3, 1 === s3 && "object" !== t3.nodeName.toLowerCase()) {
              l3 = ft2(e3), (f3 = t3.getAttribute("id")) ? g3 = f3.replace(K2, "\\$&") : t3.setAttribute("id", g3), g3 = "[id='" + g3 + "'] ", u3 = l3.length;
              while (u3--) l3[u3] = g3 + dt2(l3[u3]);
      ...
      a2 = st2.isXML = function(e3) {
        ...
        return n3 !== p2 && 9 === n3.nodeType && n3.documentElement ? (p2 = n3, f2 = n3.documentElement, d2 = a2(n3), T2.tagNameNoComments = at2(function(e4) {
          ...
          if ("*" === e4) {
            while (n4 = o3[i3++]) 1 === n4.nodeType && r3.push(n4);
            return r3;
          }
          return o3;
          ...
          var r3;
          return e4 === t3 ? (u2 = true, 0) : (r3 = t3.compareDocumentPosition && e4.compareDocumentPosition && e4.compareDocumentPosition(t3)) ? 1 & r3 || e4.parentNode && 11 === e4.parentNode.nodeType ? e4 === n3 || y2(w2, e4) ? -1 : t3 === n3 || y2(w2, t3) ? 1 : 0 : 4 & r3 ? -1 : 1 : e4.compareDocumentPosition ? -1 : 1;
        } : function(e4, t3) {
          var r3, i3 = 0, o3 = e4.parentNode, a3 = t3.parentNode, s3 = [e4], l3 = [t3];
          if (e4 === t3) return u2 = true, 0;
          if (!o3 || !a3) return e4 === n3 ? -1 : t3 === n3 ? 1 : o3 ? -1 : a3 ? 1 : 0;
          if (o3 === a3) return ut2(e4, t3);
          r3 = e4;
          while (r3 = r3.parentNode) s3.unshift(r3);
          r3 = t3;
          while (r3 = r3.parentNode) l3.unshift(r3);
          while (s3[i3] === l3[i3]) i3++;
        ...
        if ((e3.ownerDocument || e3) !== p2 && c2(e3), t3 = t3.replace(Z2, "='$1']"), !(!T2.matchesSelector || d2 || g2 && g2.test(t3) || h2.test(t3))) try {
          var n3 = m2.call(e3, t3);
          if (n3 || T2.disconnectedMatch || e3.document && 11 !== e3.document.nodeType) return n3;
        } catch (r3) {
        }
        ...
        if (u2 = !T2.detectDuplicates, e3.sort(v2), u2) {
          for (; t3 = e3[r3]; r3++) t3 === e3[r3 - 1] && (i3 = n3.push(r3));
      ...
      o2 = st2.getText = function(e3) {
        ...
        preFilter: {
          ...
          CHILD: function(e3) {
            return e3[1] = e3[1].toLowerCase(), "nth" === e3[1].slice(0, 3) ? (e3[3] || st2.error(e3[0]), e3[4] = +(e3[4] ? e3[5] + (e3[6] || 1) : 2 * ("even" === e3[3] || "odd" === e3[3])), e3[5] = +(e3[7] + e3[8] || "odd" === e3[3])) : e3[3] && st2.error(e3[0]), e3;
          },
          PSEUDO: function(e3) {
            var t3, n3 = !e3[5] && e3[2];
        ...
        filter: {
              ...
              if (m3) {
                if (o3) {
                  while (g3) {
                    p3 = t4;
                    while (p3 = p3[g3])
                      if (s3 ? p3.nodeName.toLowerCase() === y3 : 1 === p3.nodeType) return false;
                ...
                if (h3 = [a3 ? m3.firstChild : m3.lastChild], a3 && v3) {
                  ...
                  while (p3 = ++d3 && p3 && p3[g3] || (f3 = d3 = 0) || h3.pop())
                    if (1 === p3.nodeType && ++f3 && p3 === t4) {
                      c3[e3] = [N2, d3, f3];
                      break;
                    }
                } else if (v3 && (l3 = (t4[x2] || (t4[x2] = {}))[e3]) && l3[0] === N2) f3 = l3[1];
                else
                  while (p3 = ++d3 && p3 && p3[g3] || (f3 = d3 = 0) || h3.pop())
                    if ((s3 ? p3.nodeName.toLowerCase() === y3 : 1 === p3.nodeType) && ++f3 && (v3 && ((p3[x2] || (p3[x2] = {}))[e3] = [N2, f3]), p3 === t4)) break;
          ...
          PSEUDO: function(e3, t3) {
            ...
            return r3[x2] ? r3(t3) : r3.length > 1 ? (n3 = [e3, e3, "", t3], i2.setFilters.hasOwnProperty(e3.toLowerCase()) ? ot2(function(e4, n4) {
              ...
              while (a3--) i3 = M2.call(e4, o3[a3]), e4[i3] = !(n4[i3] = o3[a3]);
            }) : function(e4) {
              return r3(e4, 0, n3);
            }) : r3;
          }
        ...
        pseudos: {
          ...
          lang: ot2(function(e3) {
            return X2.test(e3 || "") || st2.error("unsupported lang: " + e3), e3 = e3.replace(et2, tt2).toLowerCase(), function(t3) {
              var n3;
              do
                if (n3 = d2 ? t3.getAttribute("xml:lang") || t3.getAttribute("lang") : t3.lang) return n3 = n3.toLowerCase(), n3 === e3 || 0 === n3.indexOf(e3 + "-");
          ...
          empty: function(e3) {
            for (e3 = e3.firstChild; e3; e3 = e3.nextSibling)
              if (e3.nodeName > "@" || 3 === e3.nodeType || 4 === e3.nodeType) return false;
            return true;
          },
          parent: function(e3) {
      ...
      function ft2(e3, t3) {
        ...
        while (s3) {
          (!n3 || (r3 = $2.exec(s3))) && (r3 && (s3 = s3.slice(r3[0].length) || s3), u3.push(o3 = [])), n3 = false, (r3 = I2.exec(s3)) && (n3 = r3.shift(), o3.push({
            value: n3,
            type: r3[0].replace(W2, " ")
          }), s3 = s3.slice(n3.length));
          for (a3 in i2.filter) !(r3 = U2[a3].exec(s3)) || l3[a3] && !(r3 = l3[a3](r3)) || (n3 = r3.shift(), o3.push({
            value: n3,
            type: a3,
            matches: r3
          }), s3 = s3.slice(n3.length));
      ...
      function ht2(e3, t3, n3) {
        var i3 = t3.dir, o3 = n3 && "parentNode" === i3, a3 = C2++;
        return t3.first ? function(t4, n4, r3) {
          while (t4 = t4[i3])
            if (1 === t4.nodeType || o3) return e3(t4, n4, r3);
        } : function(t4, n4, s3) {
          var u3, l3, c3, p3 = N2 + " " + a3;
          if (s3) {
            while (t4 = t4[i3])
              if ((1 === t4.nodeType || o3) && e3(t4, n4, s3)) return true;
          } else
            while (t4 = t4[i3])
              if (1 === t4.nodeType || o3) {
                if (c3 = t4[x2] || (t4[x2] = {}), (l3 = c3[i3]) && l3[0] === p3) {
                  if ((u3 = l3[1]) === true || u3 === r2) return u3 === true;
                } else if (l3 = c3[i3] = [p3], l3[1] = e3(t4, n4, s3) || r2, l3[1] === true) return true;
              }
        };
      }
      function gt2(e3) {
        return e3.length > 1 ? function(t3, n3, r3) {
          var i3 = e3.length;
          while (i3--)
            if (!e3[i3](t3, n3, r3)) return false;
          return true;
        } : e3[0];
      }
      function mt2(e3, t3, n3, r3, i3) {
        var o3, a3 = [], s3 = 0, u3 = e3.length, l3 = null != t3;
        for (; u3 > s3; s3++) (o3 = e3[s3]) && (!n3 || n3(o3, r3, i3)) && (a3.push(o3), l3 && t3.push(s3));
        return a3;
      }
      function yt2(e3, t3, n3, r3, i3, o3) {
        return r3 && !r3[x2] && (r3 = yt2(r3)), i3 && !i3[x2] && (i3 = yt2(i3, o3)), ot2(function(o4, a3, s3, u3) {
          ...
          if (n3 && n3(m3, y3, s3, u3), r3) {
            ...
            while (c3--) (p3 = l3[c3]) && (y3[d3[c3]] = !(m3[d3[c3]] = p3));
          }
          if (o4) {
            if (i3 || e3) {
              if (i3) {
                l3 = [], c3 = y3.length;
                while (c3--) (p3 = y3[c3]) && l3.push(m3[c3] = p3);
                i3(null, y3 = [], l3, u3);
              }
              c3 = y3.length;
              while (c3--) (p3 = y3[c3]) && (l3 = i3 ? M2.call(o4, p3) : f3[c3]) > -1 && (o4[l3] = !(a3[l3] = p3));
            }
          } else y3 = mt2(y3 === a3 ? y3.splice(h3, y3.length) : y3), i3 ? i3(null, a3, y3, u3) : H2.apply(a3, y3);
        });
      }
      function vt2(e3) {
        ...
        for (; o3 > u3; u3++)
          if (n3 = i2.relative[e3[u3].type]) f3 = [ht2(gt2(f3), n3)];
          else {
            if (n3 = i2.filter[e3[u3].type].apply(null, e3[u3].matches), n3[x2]) {
              for (r3 = ++u3; o3 > r3; r3++)
                if (i2.relative[e3[r3].type]) break;
      ...
      function bt2(e3, t3) {
        var n3 = 0, o3 = t3.length > 0, a3 = e3.length > 0, s3 = function(s4, u3, c3, f3, d3) {
          var h3, g3, m3, y3 = [], v3 = 0, b2 = "0", x3 = s4 && [], w3 = null != d3, T3 = l2, C3 = s4 || a3 && i2.find.TAG("*", d3 && u3.parentNode || u3), k3 = N2 += null == T3 ? 1 : Math.random() || 0.1;
          for (w3 && (l2 = u3 !== p2 && u3, r2 = n3); null != (h3 = C3[b2]); b2++) {
            if (a3 && h3) {
              g3 = 0;
              while (m3 = e3[g3++])
                if (m3(h3, u3, c3)) {
          ...
          if (v3 += b2, o3 && b2 !== v3) {
            g3 = 0;
            while (m3 = t3[g3++]) m3(x3, y3, u3, c3);
            if (s4) {
              if (v3 > 0)
                while (b2--) x3[b2] || y3[b2] || (y3[b2] = L2.call(f3));
              y3 = mt2(y3);
            }
      ...
      s2 = st2.compile = function(e3, t3) {
        ...
        if (!o3) {
          ...
          while (n3--) o3 = vt2(t3[n3]), o3[x2] ? r3.push(o3) : i3.push(o3);
          o3 = S2(e3, bt2(i3, r3));
        }
        return o3;
      };
      function xt2(e3, t3, n3) {
        ...
        for (; i3 > r3; r3++) st2(e3, t3[r3], n3);
        return n3;
      }
      function wt2(e3, t3, n3, r3) {
        var o3, a3, u3, l3, c3, p3 = ft2(e3);
        if (!r3 && 1 === p3.length) {
          if (a3 = p3[0] = p3[0].slice(0), a3.length > 2 && "ID" === (u3 = a3[0]).type && 9 === t3.nodeType && !d2 && i2.relative[a3[1].type]) {
            if (t3 = i2.find.ID(u3.matches[0].replace(et2, tt2), t3)[0], !t3) return n3;
            e3 = e3.slice(a3.shift().value.length);
          }
          o3 = U2.needsContext.test(e3) ? 0 : a3.length;
          while (o3--) {
            if (u3 = a3[o3], i2.relative[l3 = u3.type]) break;
            if ((c3 = i2.find[l3]) && (r3 = c3(u3.matches[0].replace(et2, tt2), V2.test(a3[0].type) && t3.parentNode || t3))) {
              if (a3.splice(o3, 1), e3 = r3.length && dt2(a3), !e3) return H2.apply(n3, q2.call(r3, 0)), n3;
              break;
            }
          }
        }
    ...
    b.fn.extend({
      find: function(e2) {
        ...
        if ("string" != typeof e2) return r2 = this, this.pushStack(b(e2).filter(function() {
          for (t2 = 0; i2 > t2; t2++)
            if (b.contains(r2[t2], this)) return true;
        }));
        for (n2 = [], t2 = 0; i2 > t2; t2++) b.find(e2, this[t2], n2);
      ...
      has: function(e2) {
        ...
        return this.filter(function() {
          for (t2 = 0; r2 > t2; t2++)
            if (b.contains(this, n2[t2])) return true;
        });
      },
      not: function(e2) {
      ...
      is: function(e2) {
        return !!e2 && ("string" == typeof e2 ? lt.test(e2) ? b(e2, this.context).index(this[0]) >= 0 : b.filter(e2, this).length > 0 : this.filter(e2).length > 0);
      },
      closest: function(e2, t2) {
        var n2, r2 = 0, i2 = this.length, o2 = [], a2 = lt.test(e2) || "string" != typeof e2 ? b(e2, t2 || this.context) : 0;
        for (; i2 > r2; r2++) {
          n2 = this[r2];
          while (n2 && n2.ownerDocument && n2 !== t2 && 11 !== n2.nodeType) {
      ...
      index: function(e2) {
        return e2 ? "string" == typeof e2 ? b.inArray(this[0], b(e2)) : b.inArray(e2.jquery ? e2[0] : e2, this) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1;
      },
      add: function(e2, t2) {
        var n2 = "string" == typeof e2 ? b(e2, t2) : b.makeArray(e2 && e2.nodeType ? [e2] : e2), r2 = b.merge(this.get(), n2);
    ...
    b.each({
      ...
      b.fn[e2] = function(n2, r2) {
        ...
        return at.test(e2) || (r2 = n2), r2 && "string" == typeof r2 && (i2 = b.filter(r2, i2)), i2 = this.length > 1 && !ct[e2] ? b.unique(i2) : i2, this.length > 1 && st.test(e2) && (i2 = i2.reverse()), this.pushStack(i2);
      };
    }), b.extend({
      filter: function(e2, t2, n2) {
        return n2 && (e2 = ":not(" + e2 + ")"), 1 === t2.length ? b.find.matchesSelector(t2[0], e2) ? [t2[0]] : [] : b.find.matches(e2, t2);
      },
      dir: function(e2, n2, r2) {
        var i2 = [], o2 = e2[n2];
        while (o2 && 9 !== o2.nodeType && (r2 === t || 1 !== o2.nodeType || !b(o2).is(r2))) 1 === o2.nodeType && i2.push(o2), o2 = o2[n2];
        return i2;
      },
    ...
    function ft(e2, t2, n2) {
      if (t2 = t2 || 0, b.isFunction(t2)) return b.grep(e2, function(e3, r3) {
        var i2 = !!t2.call(e3, r3, e3);
        return i2 === n2;
      });
      if (t2.nodeType) return b.grep(e2, function(e3) {
        return e3 === t2 === n2;
      });
      if ("string" == typeof t2) {
        ...
        if (ut.test(t2)) return b.filter(t2, r2, !n2);
        t2 = b.filter(t2, r2);
      }
    ...
    function dt(e2) {
      ...
      if (n2.createElement)
        while (t2.length) n2.createElement(t2.pop());
      return n2;
    }
    ...
    At.optgroup = At.option, At.tbody = At.tfoot = At.colgroup = At.caption = At.thead, At.th = At.td, b.fn.extend({
      ...
      remove: function(e2, t2) {
        var n2, r2 = 0;
        for (; null != (n2 = this[r2]); r2++) (!e2 || b.filter(e2, [n2]).length > 0) && (t2 || 1 !== n2.nodeType || b.cleanData(Ot(n2)), n2.parentNode && (t2 && b.contains(n2.ownerDocument, n2) && Mt(Ot(n2, "script")), n2.parentNode.removeChild(n2)));
        return this;
      },
      empty: function() {
        var e2, t2 = 0;
        for (; null != (e2 = this[t2]); t2++) {
          1 === e2.nodeType && b.cleanData(Ot(e2, false));
      ...
      html: function(e2) {
        return b.access(this, function(e3) {
          ...
          if (!("string" != typeof e3 || Tt.test(e3) || !b.support.htmlSerialize && mt.test(e3) || !b.support.leadingWhitespace && yt.test(e3) || At[(bt.exec(e3) || ["", ""])[1].toLowerCase()])) {
            e3 = e3.replace(vt, "<$1></$2>");
            try {
              for (; i2 > r2; r2++) n2 = this[r2] || {}, 1 === n2.nodeType && (b.cleanData(Ot(n2, false)), n2.innerHTML = e3);
              n2 = 0;
            } catch (o2) {
            }
          }
      ...
      replaceWith: function(e2) {
        var t2 = b.isFunction(e2);
        return t2 || "string" == typeof e2 || (e2 = b(e2).not(this).detach()), this.domManip([e2], true, function(e3) {
      ...
      domManip: function(e2, n2, r2) {
        ...
        if (m2 || !(1 >= p2 || "string" != typeof g2 || b.support.checkClone) && Ct.test(g2)) return this.each(function(i3) {
          var o3 = d2.eq(i3);
          m2 && (e2[0] = g2.call(this, i3, n2 ? o3.html() : t)), o3.domManip(e2, n2, r2);
        });
        if (p2 && (l2 = b.buildFragment(e2, this[0].ownerDocument, false, this), i2 = l2.firstChild, 1 === l2.childNodes.length && (l2 = i2), i2)) {
          for (n2 = n2 && b.nodeName(i2, "tr"), s2 = b.map(Ot(l2, "script"), Ht), a2 = s2.length; p2 > c2; c2++) o2 = l2, c2 !== h2 && (o2 = b.clone(o2, true, true), a2 && b.merge(s2, Ot(o2, "script"))), r2.call(n2 && b.nodeName(this[c2], "table") ? Lt(this[c2], "tbody") : this[c2], o2, c2);
          if (a2)
            for (u2 = s2[s2.length - 1].ownerDocument, b.map(s2, qt), c2 = 0; a2 > c2; c2++) o2 = s2[c2], kt.test(o2.type || "") && !b._data(o2, "globalEval") && b.contains(u2, o2) && (o2.src ? b.ajax({
              url: o2.src,
              type: "GET",
              dataType: "script",
              async: false,
              global: false,
              "throws": true
            }) : b.globalEval((o2.text || o2.textContent || o2.innerHTML || "").replace(St, "")));
          l2 = i2 = null;
        }
        return this;
      }
    ...
    function Mt(e2, t2) {
      var n2, r2 = 0;
      for (; null != (n2 = e2[r2]); r2++) b._data(n2, "globalEval", !t2 || b._data(t2[r2], "globalEval"));
    }
    function _t(e2, t2) {
      if (1 === t2.nodeType && b.hasData(e2)) {
        var n2, r2, i2, o2 = b._data(e2), a2 = b._data(t2, o2), s2 = o2.events;
        if (s2) {
          delete a2.handle, a2.events = {};
          for (n2 in s2)
            for (r2 = 0, i2 = s2[n2].length; i2 > r2; r2++) b.event.add(t2, n2, s2[n2][r2]);
        }
    ...
    function Ft(e2, t2) {
      ...
      if (1 === t2.nodeType) {
        if (n2 = t2.nodeName.toLowerCase(), !b.support.noCloneEvent && t2[b.expando]) {
          i2 = b._data(t2);
          for (r2 in i2.events) b.removeEvent(t2, r2, i2.handle);
          t2.removeAttribute(b.expando);
        }
        "script" === n2 && t2.text !== e2.text ? (Ht(t2).text = e2.text, qt(t2)) : "object" === n2 ? (t2.parentNode && (t2.outerHTML = e2.outerHTML), b.support.html5Clone && e2.innerHTML && !b.trim(t2.innerHTML) && (t2.innerHTML = e2.innerHTML)) : "input" === n2 && Nt.test(e2.type) ? (t2.defaultChecked = t2.checked = e2.checked, t2.value !== e2.value && (t2.value = e2.value)) : "option" === n2 ? t2.defaultSelected = t2.selected = e2.defaultSelected : ("input" === n2 || "textarea" === n2) && (t2.defaultValue = e2.defaultValue);
      }
    }
    b.each({
      appendTo: "append",
      ...
      b.fn[e2] = function(e3) {
        ...
        for (; a2 >= r2; r2++) n2 = r2 === a2 ? this : this.clone(true), b(o2[r2])[t2](n2), d.apply(i2, n2.get());
    ...
    function Ot(e2, n2) {
      ...
      if (!s2)
        for (s2 = [], r2 = e2.childNodes || e2; null != (o2 = r2[a2]); a2++) !n2 || b.nodeName(o2, n2) ? s2.push(o2) : b.merge(s2, Ot(o2, n2));
    ...
    b.extend({
      clone: function(e2, t2, n2) {
        ...
        if (b.support.html5Clone || b.isXMLDoc(e2) || !mt.test("<" + e2.nodeName + ">") ? o2 = e2.cloneNode(true) : (Dt.innerHTML = e2.outerHTML, Dt.removeChild(o2 = Dt.firstChild)), !(b.support.noCloneEvent && b.support.noCloneChecked || 1 !== e2.nodeType && 11 !== e2.nodeType || b.isXMLDoc(e2)))
          for (r2 = Ot(o2), s2 = Ot(e2), a2 = 0; null != (i2 = s2[a2]); ++a2) r2[a2] && Ft(i2, r2[a2]);
        if (t2)
          if (n2)
            for (s2 = s2 || Ot(e2), r2 = r2 || Ot(o2), a2 = 0; null != (i2 = s2[a2]); a2++) _t(i2, r2[a2]);
          else _t(e2, o2);
      ...
      buildFragment: function(e2, t2, n2, r2) {
        ...
        for (; p2 > h2; h2++)
          if (o2 = e2[h2], o2 || 0 === o2)
            if ("object" === b.type(o2)) b.merge(d2, o2.nodeType ? [o2] : o2);
            else if (wt.test(o2)) {
              ...
              if (!b.support.leadingWhitespace && yt.test(o2) && d2.push(t2.createTextNode(yt.exec(o2)[0])), !b.support.tbody) {
                o2 = "table" !== u2 || xt.test(o2) ? "<table>" !== c2[1] || xt.test(o2) ? 0 : s2 : s2.firstChild, i2 = o2 && o2.childNodes.length;
                while (i2--) b.nodeName(l2 = o2.childNodes[i2], "tbody") && !l2.childNodes.length && o2.removeChild(l2);
              }
        ...
        while (o2 = d2[h2++])
          if ((!r2 || -1 === b.inArray(o2, r2)) && (a2 = b.contains(o2.ownerDocument, o2), s2 = Ot(f2.appendChild(o2), "script"), a2 && Mt(s2), n2)) {
            i2 = 0;
      ...
      cleanData: function(e2, t2) {
        ...
        for (; null != (n2 = e2[s2]); s2++)
          if ((t2 || b.acceptData(n2)) && (o2 = n2[u2], a2 = o2 && l2[o2])) {
            if (a2.events)
              for (r2 in a2.events) f2[r2] ? b.event.remove(n2, r2) : b.removeEvent(n2, r2, a2.handle);
    ...
    function tn(e2, t2) {
      ...
      while (i2--)
        if (t2 = en[i2] + n2, t2 in e2) return t2;
      return r2;
    }
    function nn(e2, t2) {
      return e2 = t2 || e2, "none" === b.css(e2, "display") || !b.contains(e2.ownerDocument, e2);
    }
    function rn(e2, t2) {
      var n2, r2, i2, o2 = [], a2 = 0, s2 = e2.length;
      for (; s2 > a2; a2++) r2 = e2[a2], r2.style && (o2[a2] = b._data(r2, "olddisplay"), n2 = r2.style.display, t2 ? (o2[a2] || "none" !== n2 || (r2.style.display = ""), "" === r2.style.display && nn(r2) && (o2[a2] = b._data(r2, "olddisplay", un(r2.nodeName)))) : o2[a2] || (i2 = nn(r2), (n2 && "none" !== n2 || !i2) && b._data(r2, "olddisplay", i2 ? n2 : b.css(r2, "display"))));
    ...
    b.fn.extend({
      css: function(e2, n2) {
        return b.access(this, function(e3, n3, r2) {
          var i2, o2, a2 = {}, s2 = 0;
          if (b.isArray(n3)) {
            for (o2 = Rt(e3), i2 = n3.length; i2 > s2; s2++) a2[n3[s2]] = b.css(e3, n3[s2], false, o2);
            return a2;
          }
      ...
      style: function(e2, n2, r2, i2) {
        if (e2 && 3 !== e2.nodeType && 8 !== e2.nodeType && e2.style) {
          var o2, a2, s2, u2 = b.camelCase(n2), l2 = e2.style;
          if (n2 = b.cssProps[u2] || (b.cssProps[u2] = tn(l2, u2)), s2 = b.cssHooks[n2] || b.cssHooks[u2], r2 === t) return s2 && "get" in s2 && (o2 = s2.get(e2, false, i2)) !== t ? o2 : l2[n2];
          if (a2 = typeof r2, "string" === a2 && (o2 = Jt.exec(r2)) && (r2 = (o2[1] + 1) * o2[2] + parseFloat(b.css(e2, n2)), a2 = "number"), !(null == r2 || "number" === a2 && isNaN(r2) || ("number" !== a2 || b.cssNumber[u2] || (r2 += "px"), b.support.clearCloneStyle || "" !== r2 || 0 !== n2.indexOf("background") || (l2[n2] = "inherit"), s2 && "set" in s2 && (r2 = s2.set(e2, r2, i2)) === t))) try {
            l2[n2] = r2;
          } catch (c2) {
          }
        }
      ...
      css: function(e2, n2, r2, i2) {
        ...
        return n2 = b.cssProps[u2] || (b.cssProps[u2] = tn(e2.style, u2)), s2 = b.cssHooks[n2] || b.cssHooks[u2], s2 && "get" in s2 && (a2 = s2.get(e2, true, r2)), a2 === t && (a2 = Wt(e2, n2, i2)), "normal" === a2 && n2 in Kt && (a2 = Kt[n2]), "" === r2 || r2 ? (o2 = parseFloat(a2), r2 === true || b.isNumeric(o2) ? o2 || 0 : a2) : a2;
      },
      ...
      return null == u2 && l2 && l2[n2] && (u2 = l2[n2]), Yt.test(u2) && !zt.test(n2) && (i2 = l2.left, o2 = e2.runtimeStyle, a2 = o2 && o2.left, a2 && (o2.left = e2.currentStyle.left), l2.left = "fontSize" === n2 ? "1em" : u2, u2 = l2.pixelLeft + "px", l2.left = i2, a2 && (o2.left = a2)), "" === u2 ? "auto" : u2;
    });
    ...
    function an(e2, t2, n2, r2, i2) {
      ...
      for (; 4 > o2; o2 += 2) "margin" === n2 && (a2 += b.css(e2, n2 + Zt[o2], true, i2)), r2 ? ("content" === n2 && (a2 -= b.css(e2, "padding" + Zt[o2], true, i2)), "margin" !== n2 && (a2 -= b.css(e2, "border" + Zt[o2] + "Width", true, i2))) : (a2 += b.css(e2, "padding" + Zt[o2], true, i2), "padding" !== n2 && (a2 += b.css(e2, "border" + Zt[o2] + "Width", true, i2)));
      return a2;
    }
    function sn(e2, t2, n2) {
      var r2 = true, i2 = "width" === t2 ? e2.offsetWidth : e2.offsetHeight, o2 = Rt(e2), a2 = b.support.boxSizing && "border-box" === b.css(e2, "boxSizing", false, o2);
      if (0 >= i2 || null == i2) {
    ...
    function un(e2) {
      var t2 = o, n2 = Gt[e2];
      return n2 || (n2 = ln(e2, t2), "none" !== n2 && n2 || (Pt = (Pt || b("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t2.documentElement), t2 = (Pt[0].contentWindow || Pt[0].contentDocument).document, t2.write("<!doctype html><html><body>"), t2.close(), n2 = ln(e2, t2), Pt.detach()), Gt[e2] = n2), n2;
    }
    function ln(e2, t2) {
    ...
    b.each(["height", "width"], function(e2, n2) {
      b.cssHooks[n2] = {
        get: function(e3, r2, i2) {
          return r2 ? 0 === e3.offsetWidth && Xt.test(b.css(e3, "display")) ? b.swap(e3, Qt, function() {
            return sn(e3, n2, i2);
          }) : sn(e3, n2, i2) : t;
        },
        set: function(e3, t2, r2) {
          var i2 = r2 && Rt(e3);
          return on(e3, t2, r2 ? an(e3, n2, r2, b.support.boxSizing && "border-box" === b.css(e3, "boxSizing", false, i2), i2) : 0);
        }
      };
      ...
      return 0 >= e2.offsetWidth && 0 >= e2.offsetHeight || !b.support.reliableHiddenOffsets && "none" === (e2.style && e2.style.display || b.css(e2, "display"));
    ...
    b.fn.extend({
      ...
      serializeArray: function() {
        return this.map(function() {
          ...
          var n2 = b(this).val();
          return null == n2 ? null : b.isArray(n2) ? b.map(n2, function(e3) {
            return {
              name: t2.name,
              value: e3.replace(fn, "\r\n")
            };
      ...
      var r2, i2 = [], o2 = function(e3, t2) {
        t2 = b.isFunction(t2) ? t2() : null == t2 ? "" : t2, i2[i2.length] = encodeURIComponent(e3) + "=" + encodeURIComponent(t2);
      };
      if (n2 === t && (n2 = b.ajaxSettings && b.ajaxSettings.traditional), b.isArray(e2) || e2.jquery && !b.isPlainObject(e2)) b.each(e2, function() {
        o2(this.name, this.value);
      });
      else
        for (r2 in e2) gn(r2, e2[r2], n2, o2);
      return i2.join("&").replace(cn, "+");
    };
    function gn(e2, t2, n2, r2) {
      var i2;
      if (b.isArray(t2)) b.each(t2, function(t3, i3) {
        n2 || pn.test(e2) ? r2(e2, i3) : gn(e2 + "[" + ("object" == typeof i3 ? t3 : "") + "]", i3, n2, r2);
      });
      else if (n2 || "object" !== b.type(t2)) r2(e2, t2);
      else
        for (i2 in t2) gn(e2 + "[" + i2 + "]", t2[i2], n2, r2);
    }
    ...
    function Hn(e2) {
      return function(t2, n2) {
        ...
        if (b.isFunction(n2))
          while (r2 = o2[i2++]) "+" === r2[0] ? (r2 = r2.slice(1) || "*", (e2[r2] = e2[r2] || []).unshift(n2)) : (e2[r2] = e2[r2] || []).push(n2);
      };
    }
    function qn(e2, n2, r2, i2) {
      ...
      function s2(u2) {
        ...
        return o2[u2] = true, b.each(e2[u2] || [], function(e3, u3) {
          var c2 = u3(n2, r2, i2);
          return "string" != typeof c2 || a2 || o2[c2] ? a2 ? !(l2 = c2) : t : (n2.dataTypes.unshift(c2), s2(c2), false);
        }), l2;
      }
    ...
    b.fn.load = function(e2, n2, r2) {
      ...
      return u2 >= 0 && (i2 = e2.slice(u2, e2.length), e2 = e2.slice(0, u2)), b.isFunction(n2) ? (r2 = n2, n2 = t) : n2 && "object" == typeof n2 && (a2 = "POST"), s2.length > 0 && b.ajax({
        url: e2,
        type: a2,
        dataType: "html",
        data: n2
      ...
      b[n2] = function(e3, r2, i2, o2) {
        return b.isFunction(r2) && (o2 = o2 || i2, i2 = r2, r2 = t), b.ajax({
          url: e3,
          type: n2,
          dataType: o2,
          data: r2,
      ...
      ajax: function(e2, n2) {
        ...
        var r2, i2, o2, a2, s2, u2, l2, c2, p2 = b.ajaxSetup({}, n2), f2 = p2.context || p2, d2 = p2.context && (f2.nodeType || f2.jquery) ? b(f2) : b.event, h2 = b.Deferred(), g2 = b.Callbacks("once memory"), m2 = p2.statusCode || {}, y2 = {}, v2 = {}, x2 = 0, T2 = "canceled", N2 = {
          readyState: 0,
          ...
          statusCode: function(e3) {
            ...
            if (e3)
              if (2 > x2)
                for (t2 in e3) m2[t2] = [m2[t2], e3[t2]];
              else N2.always(e3[N2.status]);
            return this;
          },
          abort: function(e3) {
            var t2 = e3 || T2;
        ...
        if (h2.promise(N2).complete = g2.add, N2.success = N2.done, N2.error = N2.fail, p2.url = ((e2 || p2.url || yn) + "").replace(xn, "").replace(kn, mn[1] + "//"), p2.type = n2.method || n2.type || p2.method || p2.type, p2.dataTypes = b.trim(p2.dataType || "*").toLowerCase().match(w) || [""], null == p2.crossDomain && (r2 = En.exec(p2.url.toLowerCase()), p2.crossDomain = !(!r2 || r2[1] === mn[1] && r2[2] === mn[2] && (r2[3] || ("http:" === r2[1] ? 80 : 443)) == (mn[3] || ("http:" === mn[1] ? 80 : 443)))), p2.data && p2.processData && "string" != typeof p2.data && (p2.data = b.param(p2.data, p2.traditional)), qn(An, p2, n2, N2), 2 === x2) return N2;
        u2 = p2.global, u2 && 0 === b.active++ && b.event.trigger("ajaxStart"), p2.type = p2.type.toUpperCase(), p2.hasContent = !Cn.test(p2.type), o2 = p2.url, p2.hasContent || (p2.data && (o2 = p2.url += (bn.test(o2) ? "&" : "?") + p2.data, delete p2.data), p2.cache === false && (p2.url = wn.test(o2) ? o2.replace(wn, "$1_=" + vn++) : o2 + (bn.test(o2) ? "&" : "?") + "_=" + vn++)), p2.ifModified && (b.lastModified[o2] && N2.setRequestHeader("If-Modified-Since", b.lastModified[o2]), b.etag[o2] && N2.setRequestHeader("If-None-Match", b.etag[o2])), (p2.data && p2.hasContent && p2.contentType !== false || n2.contentType) && N2.setRequestHeader("Content-Type", p2.contentType), N2.setRequestHeader("Accept", p2.dataTypes[0] && p2.accepts[p2.dataTypes[0]] ? p2.accepts[p2.dataTypes[0]] + ("*" !== p2.dataTypes[0] ? ", " + Dn + "; q=0.01" : "") : p2.accepts["*"]);
        for (i2 in p2.headers) N2.setRequestHeader(i2, p2.headers[i2]);
        if (p2.beforeSend && (p2.beforeSend.call(f2, N2, p2) === false || 2 === x2)) return N2.abort();
        T2 = "abort";
        for (i2 in {
          success: 1,
          error: 1,
        ...
        function k2(e3, n3, r3, i3) {
          ...
          2 !== x2 && (x2 = 2, s2 && clearTimeout(s2), l2 = t, a2 = i3 || "", N2.readyState = e3 > 0 ? 4 : 0, r3 && (w2 = _n(p2, N2, r3)), e3 >= 200 && 300 > e3 || 304 === e3 ? (p2.ifModified && (T3 = N2.getResponseHeader("Last-Modified"), T3 && (b.lastModified[o2] = T3), T3 = N2.getResponseHeader("etag"), T3 && (b.etag[o2] = T3)), 204 === e3 ? (c3 = true, C2 = "nocontent") : 304 === e3 ? (c3 = true, C2 = "notmodified") : (c3 = Fn(p2, w2), C2 = c3.state, y3 = c3.data, v3 = c3.error, c3 = !v3)) : (v3 = C2, (e3 || !C2) && (C2 = "error", 0 > e3 && (e3 = 0))), N2.status = e3, N2.statusText = (n3 || C2) + "", c3 ? h2.resolveWith(f2, [y3, C2, N2]) : h2.rejectWith(f2, [N2, C2, v3]), N2.statusCode(m2), m2 = t, u2 && d2.trigger(c3 ? "ajaxSuccess" : "ajaxError", [N2, p2, c3 ? y3 : v3]), g2.fireWith(f2, [N2, C2]), u2 && (d2.trigger("ajaxComplete", [N2, p2]), --b.active || b.event.trigger("ajaxStop")));
        }
        return N2;
      },
    ...
    function _n(e2, n2, r2) {
      ...
      for (s2 in c2) s2 in r2 && (n2[c2[s2]] = r2[s2]);
      while ("*" === l2[0]) l2.shift(), o2 === t && (o2 = e2.mimeType || n2.getResponseHeader("Content-Type"));
      if (o2) {
        for (s2 in u2)
    ...
    function Fn(e2, t2) {
      ...
      if (e2.dataFilter && (t2 = e2.dataFilter(t2, e2.dataType)), u2[1])
        for (i2 in e2.converters) a2[i2.toLowerCase()] = e2.converters[i2];
      for (; r2 = u2[++s2]; )
        if ("*" !== r2) {
          if ("*" !== l2 && l2 !== r2) {
            ...
            if (i2 !== true)
              if (i2 && e2["throws"]) t2 = i2(t2);
              else try {
                t2 = i2(t2);
              } catch (c2) {
                return {
                  state: "parsererror",
                  error: i2 ? c2 : "No conversion from " + l2 + " to " + r2
                };
              }
          }
          l2 = r2;
    ...
    b.ajaxSetup({
      ...
      var o2, a2, s2, u2 = n2.jsonp !== false && (Bn.test(n2.url) ? "url" : "string" == typeof n2.data && !(n2.contentType || "").indexOf("application/x-www-form-urlencoded") && Bn.test(n2.data) && "data");
      return u2 || "jsonp" === n2.dataTypes[0] ? (o2 = n2.jsonpCallback = b.isFunction(n2.jsonpCallback) ? n2.jsonpCallback() : n2.jsonpCallback, u2 ? n2[u2] = n2[u2].replace(Bn, "$1" + o2) : n2.jsonp !== false && (n2.url += (bn.test(n2.url) ? "&" : "?") + n2.jsonp + "=" + o2), n2.converters["script json"] = function() {
        ...
        return {
          send: function(i2, o2) {
            ...
            if (n2.username ? u2.open(n2.type, n2.url, n2.async, n2.username, n2.password) : u2.open(n2.type, n2.url, n2.async), n2.xhrFields)
              for (s2 in n2.xhrFields) u2[s2] = n2.xhrFields[s2];
            ...
            try {
              for (s2 in i2) u2.setRequestHeader(s2, i2[s2]);
            } catch (l2) {
            }
            u2.send(n2.hasContent && n2.data || null), r2 = function(e2, i3) {
              ...
              try {
                if (r2 && (i3 || 4 === u2.readyState))
                  if (r2 = t, a2 && (u2.onreadystatechange = b.noop, $n && delete Pn[a2]), i3) 4 !== u2.readyState && u2.abort();
                  else {
                    p2 = {}, s3 = u2.status, l2 = u2.getAllResponseHeaders(), "string" == typeof u2.responseText && (p2.text = u2.responseText);
                    try {
                      c2 = u2.statusText;
                    } catch (f2) {
                      c2 = "";
              ...
              p2 && o2(s3, c2, p2, l2);
            }, n2.async ? 4 === u2.readyState ? setTimeout(r2) : (a2 = ++Wn, $n && (Pn || (Pn = {}, b(e).unload($n)), Pn[a2] = r2), u2.onreadystatechange = r2) : r2();
          },
          abort: function() {
            r2 && r2(t, true);
          }
    ...
    var Xn, Un, Vn = /^(?:toggle|show|hide)$/, Yn = RegExp("^(?:([+-])=|)(" + x + ")([a-z%]*)$", "i"), Jn = /queueHooks$/, Gn = [nr], Qn = {
      "*": [function(e2, t2) {
        ...
        if (o2) {
          if (n2 = +o2[2], r2 = o2[3] || (b.cssNumber[e2] ? "" : "px"), "px" !== r2 && s2) {
    ...
    function er(e2, t2, n2) {
      var r2, i2, o2 = 0, a2 = Gn.length, s2 = b.Deferred().always(function() {
        ...
        for (; u3 > a3; a3++) l2.tweens[a3].run(o3);
        ...
        stop: function(t3) {
          ...
          if (i2) return this;
          for (i2 = true; r3 > n3; n3++) l2.tweens[n3].run(1);
          return t3 ? s2.resolveWith(e2, [l2, t3]) : s2.rejectWith(e2, [l2, t3]), this;
        }
      }), c2 = l2.props;
      for (tr(c2, l2.opts.specialEasing); a2 > o2; o2++)
        if (r2 = Gn[o2].call(l2, e2, c2, l2.opts)) return r2;
      return Zn(l2, c2), b.isFunction(l2.opts.start) && l2.opts.start.call(e2, l2), b.fx.timer(b.extend(u2, {
        elem: e2,
        anim: l2,
        queue: l2.opts.queue
      })), l2.progress(l2.opts.progress).done(l2.opts.done, l2.opts.complete).fail(l2.opts.fail).always(l2.opts.always);
    }
    function tr(e2, t2) {
      var n2, r2, i2, o2, a2;
      for (i2 in e2)
        if (r2 = b.camelCase(i2), o2 = t2[r2], n2 = e2[i2], b.isArray(n2) && (o2 = n2[1], n2 = e2[i2] = n2[0]), i2 !== r2 && (e2[r2] = n2, delete e2[i2]), a2 = b.cssHooks[r2], a2 && "expand" in a2) {
          ...
          for (i2 in n2) i2 in e2 || (e2[i2] = n2[i2], t2[i2] = o2);
        } else t2[r2] = o2;
    }
    ...
    function nr(e2, t2, n2) {
      ...
      n2.queue || (c2 = b._queueHooks(e2, "fx"), null == c2.unqueued && (c2.unqueued = 0, p2 = c2.empty.fire, c2.empty.fire = function() {
        c2.unqueued || p2();
      }), c2.unqueued++, f2.always(function() {
        f2.always(function() {
          c2.unqueued--, b.queue(e2, "fx").length || c2.empty.fire();
        });
      })), 1 === e2.nodeType && ("height" in t2 || "width" in t2) && (n2.overflow = [d2.overflow, d2.overflowX, d2.overflowY], "inline" === b.css(e2, "display") && "none" === b.css(e2, "float") && (b.support.inlineBlockNeedsLayout && "inline" !== un(e2.nodeName) ? d2.zoom = 1 : d2.display = "inline-block")), n2.overflow && (d2.overflow = "hidden", b.support.shrinkWrapBlocks || f2.always(function() {
        d2.overflow = n2.overflow[0], d2.overflowX = n2.overflow[1], d2.overflowY = n2.overflow[2];
      }));
      for (i2 in t2)
        if (a2 = t2[i2], Vn.exec(a2)) {
          if (delete t2[i2], u2 = u2 || "toggle" === a2, a2 === (m2 ? "hide" : "show")) continue;
          g2.push(i2);
        }
      if (o2 = g2.length) {
        s2 = b._data(e2, "fxshow") || b._data(e2, "fxshow", {}), "hidden" in s2 && (m2 = s2.hidden), u2 && (s2.hidden = !m2), m2 ? b(e2).show() : f2.done(function() {
          ...
          for (t3 in h2) b.style(e2, t3, h2[t3]);
        });
        for (i2 = 0; o2 > i2; i2++) r2 = g2[i2], l2 = f2.createTween(r2, m2 ? s2[r2] : 0), h2[r2] = s2[r2] || b.style(e2, r2), r2 in s2 || (s2[r2] = l2.start, m2 && (l2.end = l2.start, l2.start = "width" === r2 || "height" === r2 ? 1 : 0));
      }
    }
    ...
    b.Tween = rr, rr.prototype = {
      ...
      _default: {
        get: function(e2) {
          var t2;
          return null == e2.elem[e2.prop] || e2.elem.style && null != e2.elem.style[e2.prop] ? (t2 = b.css(e2.elem, e2.prop, ""), t2 && "auto" !== t2 ? t2 : 0) : e2.elem[e2.prop];
        },
        set: function(e2) {
          b.fx.step[e2.prop] ? b.fx.step[e2.prop](e2) : e2.elem.style && (null != e2.elem.style[b.cssProps[e2.prop]] || b.cssHooks[e2.prop]) ? b.style(e2.elem, e2.prop, e2.now + e2.unit) : e2.elem[e2.prop] = e2.now;
        }
      }
      ...
      stop: function(e2, n2, r2) {
        ...
        return "string" != typeof e2 && (r2 = n2, n2 = e2, e2 = t), n2 && e2 !== false && this.queue(e2 || "fx", []), this.each(function() {
          var t2 = true, n3 = null != e2 && e2 + "queueHooks", o2 = b.timers, a2 = b._data(this);
          if (n3) a2[n3] && a2[n3].stop && i2(a2[n3]);
          else
            for (n3 in a2) a2[n3] && a2[n3].stop && Jn.test(n3) && i2(a2[n3]);
      ...
      finish: function(e2) {
        return e2 !== false && (e2 = e2 || "fx"), this.each(function() {
          ...
          for (n2.finish = true, b.queue(this, e2, []), i2 && i2.cur && i2.cur.finish && i2.cur.finish.call(this), t2 = o2.length; t2--; ) o2[t2].elem === this && o2[t2].queue === e2 && (o2[t2].anim.stop(true), o2.splice(t2, 1));
    ...
    b.each({
      ...
      var r2 = e2 && "object" == typeof e2 ? b.extend({}, e2) : {
        complete: n2 || !n2 && t2 || b.isFunction(e2) && e2,
        duration: e2,
        easing: n2 && t2 || t2 && !b.isFunction(t2) && t2
      };
      return r2.duration = b.fx.off ? 0 : "number" == typeof r2.duration ? r2.duration : r2.duration in b.fx.speeds ? b.fx.speeds[r2.duration] : b.fx.speeds._default, (null == r2.queue || r2.queue === true) && (r2.queue = "fx"), r2.old = r2.complete, r2.complete = function() {
      ...
      for (Xn = b.now(); n2.length > r2; r2++) e2 = n2[r2], e2() || n2[r2] !== e2 || n2.splice(r2--, 1);
      ...
      fast: 200,
      _default: 400
    }, b.fx.step = {}, b.expr && b.expr.filters && (b.expr.filters.animated = function(e2) {
      ...
      var n2, r2, o2 = {
        top: 0,
        left: 0
      }, a2 = this[0], s2 = a2 && a2.ownerDocument;
      if (s2) return n2 = s2.documentElement, b.contains(n2, a2) ? (typeof a2.getBoundingClientRect !== i && (o2 = a2.getBoundingClientRect()), r2 = or(s2), {
        top: o2.top + (r2.pageYOffset || n2.scrollTop) - (n2.clientTop || 0),
        left: o2.left + (r2.pageXOffset || n2.scrollLeft) - (n2.clientLeft || 0)
      }) : o2;
    }, b.offset = {
      setOffset: function(e2, t2, n2) {
        var r2 = b.css(e2, "position");
        "static" === r2 && (e2.style.position = "relative");
        var i2 = b(e2), o2 = i2.offset(), a2 = b.css(e2, "top"), s2 = b.css(e2, "left"), u2 = ("absolute" === r2 || "fixed" === r2) && b.inArray("auto", [a2, s2]) > -1, l2 = {}, c2 = {}, p2, f2;
        u2 ? (c2 = i2.position(), p2 = c2.top, f2 = c2.left) : (p2 = parseFloat(a2) || 0, f2 = parseFloat(s2) || 0), b.isFunction(t2) && (t2 = t2.call(e2, n2, o2)), null != t2.top && (l2.top = t2.top - o2.top + p2), null != t2.left && (l2.left = t2.left - o2.left + f2), "using" in t2 ? t2.using.call(e2, l2) : i2.css(l2);
      }
    }, b.fn.extend({
      position: function() {
        if (this[0]) {
          ...
          return "fixed" === b.css(r2, "position") ? t2 = r2.getBoundingClientRect() : (e2 = this.offsetParent(), t2 = this.offset(), b.nodeName(e2[0], "html") || (n2 = e2.offset()), n2.top += b.css(e2[0], "borderTopWidth", true), n2.left += b.css(e2[0], "borderLeftWidth", true)), {
            top: t2.top - n2.top - b.css(r2, "marginTop", true),
            left: t2.left - n2.left - b.css(r2, "marginLeft", true)
          };
        }
      },
      offsetParent: function() {
        return this.map(function() {
          ...
          while (e2 && !b.nodeName(e2, "html") && "static" === b.css(e2, "position")) e2 = e2.offsetParent;
    ...
    function or(e2) {
      return b.isWindow(e2) ? e2 : 9 === e2.nodeType ? e2.defaultView || e2.parentWindow : false;
    }
    b.each({
      Height: "height",
      Width: "width"
      ...
      b.each({
        ...
        b.fn[i2] = function(i3, o2) {
          ...
          return b.access(this, function(n3, r3, i4) {
            var o3;
            return b.isWindow(n3) ? n3.document.documentElement["client" + e2] : 9 === n3.nodeType ? (o3 = n3.documentElement, Math.max(n3.body["scroll" + e2], o3["scroll" + e2], n3.body["offset" + e2], o3["offset" + e2], o3["client" + e2])) : i4 === t ? b.css(n3, r3, s2) : b.style(n3, r3, i4, s2);
          }, n2, a2 ? i3 : t, a2, null);
        };
      });
